...
@MessageDriven(activationConfig = {
        ...
        @ActivationConfigProperty(propertyName = "messageSelector", propertyValue = "gender = true")
})
public class MaleEmployeeFilter implements MessageListener {
